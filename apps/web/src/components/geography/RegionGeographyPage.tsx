...
function getPresentation(
  ...
  if (context.slug === "maharashtra") {
    return {
      title: "Explore Maharashtra.",

      description:
        "Move through cities and places across Maharashtra while connecting projects, products, knowledge, people, organisations and opportunities through one Arknoz geography system.",
      ...
      ticker: [
        {
          text:
            "Explore opportunities across Maharashtra",
          href:
            "/opportunities?geo=maharashtra",
        },
        {
          text:
            "Explore cities already connected in Maharashtra",
          href:
            "#cities",
        },
        {
          text:
            "Discover projects and knowledge across Maharashtra",
          href:
            "#connected",
        },
        {
          text:
            "Move from Maharashtra to city to place",
          href:
            "#cities",
        },
      ],
  ...
  return {
    ...
    description:
      `Explore cities, places and connected Built World records across ${context.name}.`,
...
export default function RegionGeographyPage({
  context,
}: {
  context: GeographyItem;
}) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <UniversalTopicHero
        ...
        searchPlaceholder={
          `Search ${context.name} — city, place, project, organisation or topic...`
        }
        popular={
        ...
        <div className="mx-auto max-w-[1600px] px-6 lg:px-10">
          ...
          <div className="flex flex-wrap items-end justify-between gap-5">
            ...
            <div>
              ...
              <p className="mt-2 max-w-3xl text-slate-600">
                Move from the regional view into cities and places while keeping every Arknoz record connected to one canonical geography.
              </p>
          ...
          {children.length > 0 ? (
            ...
            <div className="mt-7 rounded-[24px] border border-slate-200 bg-white p-6 text-sm text-slate-500">
              City and place pages will appear when genuine Arknoz geography records are available.
            </div>
