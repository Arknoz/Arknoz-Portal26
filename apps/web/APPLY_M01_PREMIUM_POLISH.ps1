...
Write-Host ""
Write-Host "ARKNOZ M01 PREMIUM POLISH" -ForegroundColor Cyan
Write-Host "No sections are added or removed." -ForegroundColor Cyan
Write-Host ""
$file1 = @'
"use client";
...
'@
$dest1 = Join-Path $target "src\components\GlobalHero.tsx"
[System.IO.File]::WriteAllText(
    $dest1,
    $file1,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Polished: src\components\GlobalHero.tsx" -ForegroundColor Green
...
'@
$dest2 = Join-Path $target "src\components\LiveTicker.tsx"
[System.IO.File]::WriteAllText(
    $dest2,
    $file2,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Polished: src\components\LiveTicker.tsx" -ForegroundColor Green
...
Write-Host "Polished: src\components\ExploreWorlds.tsx" -ForegroundColor Green
...
'@
$dest4 = Join-Path $target "src\components\M01WorldFeatureSplit.tsx"
[System.IO.File]::WriteAllText(
    $dest4,
    $file4,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Polished: src\components\M01WorldFeatureSplit.tsx" -ForegroundColor Green
...
'@
$dest5 = Join-Path $target "src\components\EditorsChoice.tsx"
[System.IO.File]::WriteAllText(
    $dest5,
    $file5,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Polished: src\components\EditorsChoice.tsx" -ForegroundColor Green
...
'@
$dest6 = Join-Path $target "src\components\M01ActionConnectionsRow.tsx"
[System.IO.File]::WriteAllText(
    $dest6,
    $file6,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Polished: src\components\M01ActionConnectionsRow.tsx" -ForegroundColor Green
...
'@
$dest7 = Join-Path $target "src\components\M01CommunityDiscoverRow.tsx"
[System.IO.File]::WriteAllText(
    $dest7,
    $file7,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Polished: src\components\M01CommunityDiscoverRow.tsx" -ForegroundColor Green
...
'@
$dest8 = Join-Path $target "src\components\PhaseRoadmap.tsx"
[System.IO.File]::WriteAllText(
    $dest8,
    $file8,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Polished: src\components\PhaseRoadmap.tsx" -ForegroundColor Green
...
Write-Host ""
Write-Host "DONE: M01 premium polish applied." -ForegroundColor Green
