...
Write-Host ""
Write-Host "ARKNOZ UTF-8 DISPLAY FIX" -ForegroundColor Cyan
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest1 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest1,
    $file1,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\BuiltWorldPulse.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest2 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest2,
    $file2,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\EditorsChoice.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest3 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest3,
    $file3,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\ExploreWorlds.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest4 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest4,
    $file4,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\FooterMetricsPanel.tsx" -ForegroundColor Green
        ...
        <div className="mt-6 border-t border-white/10 pt-4">
          <div className="grid gap-4 md:grid-cols-[220px_1fr_auto] md:items-end">
            ...
            <div className="text-[11px] leading-5 text-slate-400">
              <p>© 2026 Arknoz Private Limited. All rights reserved.</p>
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest5 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest5,
    $file5,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\GlobalFooter.tsx" -ForegroundColor Green
        ...
        <nav className="hidden items-center gap-7 text-sm font-medium text-slate-700 lg:flex">
          {nav.map(([label, href]) => (
            <Link
              key={href}
              href={href}
              className="flex items-center gap-1 hover:text-[#17315c]"
            >
              {label}
              {(label === "Connect" || label === "Intelligence") && (
                <span className="text-xs">🔒</span>
              )}
              {label === "Global" && <span>▾</span>}
            </Link>
          ))}
        </nav>

        <div className="hidden items-center gap-3 text-sm text-slate-700 md:flex">
          <Link href="/search" aria-label="Search" className="px-2 text-xl">
            ⌕
          </Link>
            ...
            <nav className="flex flex-col">
              {nav.map(([label, href]) => (
                <Link
                  ...
                  className="border-b border-slate-100 py-4 font-semibold text-slate-800"
                >
                  {label}
                  {(label === "Connect" || label === "Intelligence") && "  🔒"}
                </Link>
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest6 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest6,
    $file6,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\GlobalHeader.tsx" -ForegroundColor Green
    ...
    <section id="search" className="relative overflow-hidden bg-[#08203d] text-white">
      ...
      <div className="relative mx-auto grid min-h-[620px] max-w-[1600px] items-center gap-12 px-6 py-16 lg:grid-cols-[1.45fr_.95fr] lg:px-10">
        <div className="max-w-5xl">
          ...
          >
            <span className="pl-5 text-xl text-slate-500">⌕</span>
            <input
              value={query}
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest7 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest7,
    $file7,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\GlobalHero.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest8 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest8,
    $file8,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\LanguageControl.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest9 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest9,
    $file9,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\LiveTicker.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest10 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest10,
    $file10,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\M01ActionConnectionsRow.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest11 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest11,
    $file11,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\M01CommunityDiscoverRow.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest12 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest12,
    $file12,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\M01WorldFeatureSplit.tsx" -ForegroundColor Green
...
New-Item -ItemType Directory -Force -Path (Split-Path $dest13 -Parent) | Out-Null
[System.IO.File]::WriteAllText(
    $dest13,
    $file13,
    (New-Object System.Text.UTF8Encoding($false))
)
Write-Host "Rewritten UTF-8: src\components\PhaseRoadmap.tsx" -ForegroundColor Green


# Remove abandoned multilingual source files if any remain.
$delete = @(
    "src\proxy.ts",
    "src\lib\i18n.ts",
...
Write-Host ""
Write-Host "Checking for common mojibake patterns..." -ForegroundColor Cyan
...
$bad = Get-ChildItem (Join-Path $target "src") -Recurse -File -Include *.ts,*.tsx |
    Select-String -SimpleMatch -Pattern $badPatterns

if ($bad) {
    Write-Host ""
    Write-Host "WARNING: Some corrupted text still exists:" -ForegroundColor Red
    $bad | ForEach-Object {
...
Write-Host ""
Write-Host "PASS: No common mojibake patterns found." -ForegroundColor Green
Write-Host "The English M01 source has been rewritten as UTF-8." -ForegroundColor Green
Write-Host ""
